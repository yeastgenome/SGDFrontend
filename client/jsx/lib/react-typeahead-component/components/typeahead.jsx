...
module.exports = createReactClass({
  ...
  UNSAFE_componentWillReceiveProps: function (nextProps) {
    var nextValue = nextProps.inputValue,
      ...
      isHintVisible =
        ...
        nextProps.handleHint(nextValue, nextOptions).slice(valueLength).length >
          0;
  ...
  renderAriaMessageForOptions: function () {
    ...
    return (
      <AriaStatus message={props.getMessageForOption(option) || inputValue} />
    );
  },
  ...
  showHint: function () {
    var _this = this,
      ...
      isHintVisible =
        ...
        // A visible part of the hint must be
        // available for us to complete it.
        props.handleHint(inputValue, props.options).slice(inputValueLength)
          .length > 0;
          ...
          if (isDropdownVisible) {
            ...
            _this.navigate(dir, function () {
              ...
              if (selectedIndex >= 0) {
                ...
                if (
                  optionOffsetTop + selectedOption.clientHeight >
