...
module.exports = React.createClass({
    ...
    componentWillMount: function () {
        ...
        _this.activeDescendantId =
            'react-typeahead-activedescendant-' + uniqueId
    ...
    componentWillReceiveProps: function (nextProps) {
        var nextValue = nextProps.inputValue,
            ...
            isHintVisible =
                ...
                nextProps.handleHint(nextValue, nextOptions).slice(valueLength)
                    .length > 0
                ...
                {props.options.map(function (data, index) {
                    ...
                    return (
                        <li
                            ...
                            onMouseOver={_this.handleOptionMouseOver.bind(
                                _this,
                                index
                            )}
                        >
    ...
    renderAriaMessageForIncomingOptions: function () {
        ...
        return (
            <AriaStatus
                message={props.getMessageForIncomingOptions(
        ...
        var _this = this,
            ...
            isHintVisible =
                ...
                props
                    ...
                    .slice(inputValueLength).length > 0
        ...
        switch (key) {
            ...
            case 'Tab':
                if (isHintVisible && !event.shiftKey) {
                    ...
                    props.onComplete(
                        event,
                        props.handleHint(props.inputValue, props.options)
                    )
                }
                break
            case 'ArrowLeft':
                    ...
                    if (isDropdownVisible) {
                        ...
                        _this.navigate(dir, function () {
                            ...
                            if (selectedIndex >= 0) {
                                ...
                                dropdown = ReactDOM.findDOMNode(
                                    _this.refs.dropdown
                                )
                                selectedOption =
                                    dropdown.children[selectedIndex]
