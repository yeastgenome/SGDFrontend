...
const Primer3 = React.createClass({
  ...
  renderForm() {
    ...
    const formLayout = locals => {
      return (
       <div>
        <span style={{ textAlign: "center" }}><h1>Primer Design: Uses Primer3-py <a href='https://pypi.org/project/primer3-py/0.5.5/' target='_new'> package </a> <a href='https://sites.google.com/view/yeastgenome-help/analyze-help/primer-design' target='_new'><i className='fa primer-help'/> <img src="https://d1x6jdqbvd5dr.cloudfront.net/legacy_img/icon_help_circle_dark.png"></img></a></h1><hr/></span>
