...
const GoTermFinder = createReactClass({
  ...
  onSubmit(e) {
    ...
    if (warningMsg != '') {
      ...
      var win = window.open('', warningMsg, "toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=780,height=200,top="+(screen.height-400)+",left="+(screen.width-840));
