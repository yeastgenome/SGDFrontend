...
const GoTermFinder = React.createClass({
	...
	getPage() {
		...
		var param = this.state.param;
			...
			resultTable = "<br><a name='table'>" + "<h2><center>Search Results in HTML Table Format</center></h2>" + tableSaveOptions + "<font size=12>" + resultTable + "</font>";
			graph = "<a name='graph'>" + "<h2><center>Search Results in GO View Tree Image Format</center></h2>" + graphSaveOptions + "<font size=12>" + graph + "</font>";
