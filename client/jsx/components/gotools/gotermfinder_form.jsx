...
const GoTermFinder = React.createClass({
	...
	getOntology() {
		...
		return (<div style={{ textAlign: "top" }}>
		        ...
		        <p><h3><RadioSelector name='filter' elements={_elements} initialActiveElementKey='F'/></h3></p>
	...
	getGeneBox() {
		...
		// var evidenceCodes = this.getEvidenceCodes();
			...
			<h3><strong>Enter Gene/ORF names</strong> (separated by a return or a space):</h3>
                        <p><textarea ref='genes' onChange={this._onChange} name='genes' rows='5' cols='150'></textarea></p>
