...
const GoTermFinder = React.createClass({
	...
	getFrontPage() {
		...
		var _evidenceSection = { headers: [[<span style={ style.textFont }><a name='step4'>Step 4. Pick evidence codes for calculation</a></span>, <span style={ style.textFont }><a name='step5'>Step 5. Select a p-value cutoff</a></span>, <span style={ style.textFont }><a name='step6'>And/or toggle False Discovery Rate</a></span>]],
