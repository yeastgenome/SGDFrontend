...
module.exports = createReactClass({
  ...
  render: function () {
    ...
    var isTable =
      this.state.isTable === null
        ? this.props.isInitiallyTable
        : this.state.isTable;
      ...
      <div className="table-alternative">
        <ul className="tabs sgd-tabs" data-tab>
          <li className={!isTable ? 'tab-title active' : 'tab-title'}>
            ...
            >
              <i className="fa fa-bar-chart-o"></i>&nbsp;Graph
            </a>
          </li>
          <li className={isTable ? 'tab-title active' : 'tab-title'}>
            <a
        ...
        <div className="table-alternative-content-container">{dataNode}</div>
      </div>
    );
  },
  ...
  _getDataNode: function () {
    if (this.state.isTable) {
      return (
        <div>
          <p
            style={{ position: 'absolute', marginTop: 6, marginLeft: '1em' }}
          ></p>
      ...
      var vizNodeTypes = {
        bar: (
          <BarChart
            data={this.props.graphData.combined}
            yValue={function (d) {
              return d.value;
            }}
