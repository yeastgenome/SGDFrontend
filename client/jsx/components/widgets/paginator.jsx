...
var Paginator = createReactClass({
  ...
  render: function () {
    ...
    } of ${this.props.totalPages.toLocaleString()}`;
    var prevPageNum = this.props.currentPage - 1;
    var nextPageNum = this.props.currentPage + 1;
    var onClickPrev = (e) => {
      this._onPaginate(prevPageNum);
    };
    var onClickNext = (e) => {
      this._onPaginate(nextPageNum);
    };
    ...
    return (
      <div style={[style.wrapper]}>
        ...
        <p style={[style.text]}>
          <a
            onClick={onClickPrev}
            className={'button tiny secondary' + prevKlass}
            style={[style.button]}
          >
          ...
          <a
            onClick={onClickNext}
            className={'button tiny secondary' + nextKlass}
            style={[style.button]}
          >
  ...
  _onPaginate: function (newPageNum) {
    ...
    if (typeof this.props.onPaginate === 'function')
      this.props.onPaginate(newPageNum);
  },
});
