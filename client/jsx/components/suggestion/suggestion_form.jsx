    ...
    if (this.state.isComplete) {
      return (
        <div>
          <div className="row">
            <p>
              <b>Thank you for your suggestion.</b>
            </p>
            <p>
              A copy of your email has been sent to{' '}
              <b> {this.state.userEmail} </b>. If you do not receive this email
              shortly, then you may have entered an invalid email address.
            </p>
            <ul>
      ...
      return (
        <div>
          <div className="row">
            <p>
              <b>
                Please fix your email address or verify the captcha before
                submitting the info.
              </b>
            </p>
          </div>
          ...
          <form onSubmit={this._onSubmit}>
            <div className="row">
              <div className="large-12 columns">
                <p>
                  Please fill in your name and e-mail address to send mail to a
                  curator sgd-helpdesk@lists.stanford.edu
                </p>
                <label>
                ...
                <p></p>
                <label>
                  E-mail: <span className="red">(Required)</span>
                </label>
                <br />
                <input
                  type="text"
