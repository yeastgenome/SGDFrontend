...
var AsyncSequenceView = createReactClass({
  ...
  _get2dStructureNode: function () {
    ...
    let helpNode = (
      <HelpIcon
        text="Secondary structures are provided by <a href='https://rnacentral.org' target='new'>RNAcentral</a> and were generated by <a href='https://github.com/RNAcentral/r2dt' target='new'>R2DT</a> using the <i>E-Ala</i> template provided by <a href='http://gtrnadb.ucsc.edu' target='new'>GtRNAdb</a>. For more information, see the <a href='https://rnacentral.org/help/secondary-structure' target='new'>Help page</a> at RNAcentral."
        isInfo={true}
      />
    );
