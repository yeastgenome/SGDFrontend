...
const StyleGuide = createReactClass({
  ...
  render() {
    return (
      <div className="row">
        <div className="columns small-2">{this._renderNavBar()}</div>
        <div className="columns small-10">
          <h1>Style Guide</h1>
          <hr />
          <div id="colors">{this._renderColors()}</div>
          <div id="typeography" style={[style.sectionContainer]}>
            <h2>Typography</h2>
            <hr />
            <p>
              Headings are in a serif font. Other text is in a sans-serif font.
              The title of the page is an <code>h1</code> tag. The sub-headings
              are <code>h2</code> tags, with an <code>hr</code> element
              underneath. This page is a correct example.
            </p>
          </div>
          ...
          <div id="help" style={[style.sectionContainer]}>
            ...
            <hr />
            <p>
              Add some inline text to help users.{' '}
              <HelpIcon text="To do the thing you want to do, eat more vegetables." />
            </p>
          </div>
          <div id="buttons" style={[style.sectionContainer]}>
            <h2>Buttons</h2>
            <hr />
            <a className="button small secondary" style={[style.button]}>
              Basic
            </a>
            <a className="button small" style={[style.button]}>
              More Attention
            </a>
          ...
          <div id="formatting" style={[style.sectionContainer]}>
            ...
            <hr />
            <p>
              Literature citations should be formatted in the following manner.
            </p>
            <div>
              <ul className="literature-list">
                <li>
                  <a href="/reference/S000180759/overview">
                    Park E, et al. (2015)
                  </a>{' '}
                  <span>
                    Structure of a Bud6/Actin Complex Reveals a Novel WH2-like
                    Actin Monomer Recruitment Motif. Structure 23(8):1492-9
                  </span>{' '}
                  <small>PMID:26118535</small>
                  <ul className="ref-links">
                    <li>
                      <a href="/reference/S000180759/overview">SGD Paper</a>
                    </li>
                    <li>
                      <a
                        href="http://www.ncbi.nlm.nih.gov/pubmed/23653364"
                        targer="_blank"
                      >
                        PubMed
                      </a>
            ...
            <p>
              Or, for a summerized citation version (such as in a table), format
              like this.
            </p>
            <p>
              <a href="/reference/S000180759/overview">Park E, et al. (2015)</a>{' '}
              <small>PMID:26118535</small>
            </p>
          </div>
          <div id="formatting" style={[style.sectionContainer]}>
            ...
            <hr />
            <p>
              When waiting for something really slow, please use a loader like
              this. No images, just CSS-fu.
            </p>
  ...
  _renderColors() {
    ...
    return (
      <div>
        ...
        <hr />
        <p>
          As much as possible, ONLY the following colors should be used on SGD.
        </p>
  ...
  _renderForms() {
    ...
    return (
      <div>
        ...
        <TForm
          validationObject={exampleObject}
          submitText="Save"
          onSubmit={_onSubmit}
        />
      </div>
