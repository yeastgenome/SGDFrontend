...
module.exports = createReactClass({
  ...
  render: function () {
    ...
    var chromNode = (
      <rect
        className="chromosome-thumb-arm"
        x={0}
        y={0}
    ...
    var _lDomainStyle = _.extend(_.clone(_domainStyle), {
      left: 0,
      width: _lbX,
      borderRadius: `${borderRadius}px 0 0 ${borderRadius}px`,
    });
    var _rDomainStyle = _.extend(_.clone(_domainStyle), {
      left: _rbX,
      right: 0,
    ...
    var leftDomainNode = (
      <div className="chromosome-thumb-inset" style={_lDomainStyle} />
    );
    var centerDomainNode = (
      <div className="chromosome-thumb-center-inset" style={_cDomainStyle} />
    );
    var rightDomainNode = (
      <div className="chromosome-thumb-inset" style={_rDomainStyle} />
    );
  ...
  _getScale: function () {
    return d3.scale
      .linear()
      .domain([0, this.props.totalLength])
