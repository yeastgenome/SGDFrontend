...
module.exports = React.createClass({
    ...
    render: function () {
        ...
        var labelNode = this.props.labelText ? (
            <p
                ...
                style={{ marginLeft: this.props.left, position: 'relative' }}
            >
        ...
        var _klass = `standalone-axis ${
            this.props.gridTicks ? 'grid-ticks' : ''
        }`
        return (
    ...
    _calculateScale: function (nextProps) {
        ...
        var _width =
            ReactDOM.findDOMNode(this).getBoundingClientRect().width - 1
        var _xOffset = _width * props.leftRatio
        var _scale = _baseScale
            .domain(props.domain)
            .range([0, _width - _xOffset])
    ...
    _renderSVG: function () {
        ...
        var _tickSize = this.props.gridTicks
