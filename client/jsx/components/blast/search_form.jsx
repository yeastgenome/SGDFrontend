...
BLAST Help at NCBI</a>.</p><hr>'
    ...
    _getCommentBoxNode: function () {
        return (
            <div>
                <h3>
                    Query Comment (optional, will be added to output for your
                    use):
                </h3>
    ...
    _getSeqBoxNode: function (seq) {
        return (
            <div>
                {this._submitNode}
                <h3>
                    Upload Local TEXT File: FASTA, GCG, and RAW sequence formats
                    are okay
                </h3>
    ...
    _getDatabaseNode: function (data) {
        ...
        return (
            <div>
                ...
                Select or unselect multiple datasets by pressing the Control
                (PC) or Command (Mac) key while clicking. Selecting a category
                label selects all datasets in that category.
                <p>
                    <select
                        ref="database"
                        id="database"
    ...
    _getOptionsNode: function (data) {
        ...
        return (
            <div>
                <b>Options:</b> For descriptions of BLAST options and
                parameters, refer to the BLAST documentation at NCBI.<br></br>
                    ...
                    <table width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{filterMenu}</td>
                                <td>
                                    DUST file for BLASTN, SEG filter for all
                                    others
                                </td>
                            </tr>
                        </tbody>
