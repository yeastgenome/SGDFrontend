      ...
      <header id="layout-page-header" ref="wrapper">
        ...
        <div className="hide-for-small">
          <div className="top-header">
            ...
            <div className="site-links">
              ...
              <a href="https://www.yeastgenome.org/search?q=&is_quick=true">
                Explore
              </a>
              <a
                className="hide-external-link-icon"
        ...
        <section>
          <div className="menu-bar-container">
            ...
            <div className="top-menu-container">{this._renderMenu()}</div>
          ...
          <ul className="left">
            <li className="has-dropdown">
              ...
              <ul className="dropdown">
                ...
                <li>
                  <a className="disabled-header-a" href="/blast-sgd">
                    BLAST
                  </a>
                </li>
                <li>
                  <a className="disabled-header-a" href="/blast-fungal">
                    Fungal BLAST
                  </a>
                </li>
                <li>
                  <a className="disabled-header-a" href="/goTermFinder">
                    GO Term Finder
                  </a>
                </li>
                <li>
                  <a className="disabled-header-a" href="/goSlimMapper">
                    GO Slim Mapper
                  </a>
                </li>
                <li>
                  <a className="disabled-header-a" href="/nph-patmatch">
                    Pattern Matching
                  </a>
                </li>
                <li>
                  <a className="disabled-header-a" href="/primer3">
                    Design Primers
                  </a>
                </li>
                <li>
                  <a className="disabled-header-a" href="/restrictionMapper">
            ...
            <li className="has-dropdown">
              ...
              <ul className="dropdown">
                <li>
                  <a
                    className="disabled-header-a"
                    href="https://downloads.yeastgenome.org/sequence/"
                  >
                    Download
                  </a>
                </li>
                ...
                <li>
                  <a className="disabled-header-a" href="/seqTools">
                ...
                <li className="has-dropdown">
                  ...
                  <ul className="dropdown">
                    <li>
                      <a
                        className="disabled-header-a"
                        href="https://downloads.yeastgenome.org/sequence/S288C_reference/genome_releases/"
                      >
                        Download Genome
                      </a>
                    </li>
                    <li>
                      <a className="disabled-header-a" href="/genomesnapshot">
                        Genome Snapshot
                      </a>
                    </li>
                    <li>
                ...
                <li className="has-dropdown">
                  ...
                  <ul className="dropdown">
                    <li>
                      <a
                        className="disabled-header-a"
                        href="/variant-viewer#/?_k=3yu0l3"
                      >
                        Variant Viewer
                      </a>
                    </li>
                    <li>
                      <a className="disabled-header-a" href="/showAlignment">
                ...
                <li className="has-dropdown">
                  ...
                  <ul className="dropdown">
                    ...
                    <li>
                      <a
                        className="disabled-header-a"
                        href="http://www.ebi.ac.uk/interpro/"
                      >
                        InterPro (EBI)
                      </a>
                    </li>
                    <li>
                      <a
                        className="disabled-header-a"
                        href="http://www.ncbi.nlm.nih.gov/homologene"
                      >
                        HomoloGene (NCBI)
                      </a>
                    </li>
                    <li>
                      <a
                        className="disabled-header-a"
                        href="http://wolfe.gen.tcd.ie/ygob/"
                      >
            ...
            <li className="has-dropdown">
              ...
              <ul className="dropdown">
                <li className="has-dropdown">
                  ...
                  <ul className="dropdown">
                    ...
                    <li>
                      <a
                        className="disabled-header-a"
                        href="https://downloads.yeastgenome.org/curation/literature/go_slim_mapping.tab"
                      >
                ...
                <li>
                  <a
                    className="disabled-header-a"
                    href="https://spell.yeastgenome.org/"
                  >
                    Expression
                  </a>
                </li>
                <li>
                  <a
                    className="disabled-header-a"
                    href="https://pathway.yeastgenome.org"
                  >
                ...
                <li>
                  <a className="disabled-header-a" href="/interaction-search">
                    Interactions
                  </a>
                </li>
                <li>
                  <a
                    className="disabled-header-a"
                    href="https://yeastgfp.yeastgenome.org/"
                  >
                    YeastGFP
                  </a>
                </li>
            ...
            <li className="has-dropdown">
              ...
              <ul className="dropdown">
                <li>
                  <a
                    className="disabled-header-a"
                    href="https://textpresso.yeastgenome.org/"
                  >
                    Full-text Search
                  </a>
                </li>
                <li>
                  <a className="disabled-header-a" href="/reference/recent">
                    New Yeast Papers
                  </a>
                </li>
                <li>
            ...
            <li className="has-dropdown">
              ...
              <ul className="dropdown">
                <li className="has-dropdown">
                  ...
                  <ul className="dropdown">
                    <li>
                      <a
                        className="disabled-header-a"
                        href="/search?category=colleague&page=0"
                      >
                        Find a Colleague
                      </a>
                    </li>
                    <li>
                      <a href="/colleague_update">Add or Update Info</a>
                    </li>
                    <li>
                      <a
                        className="disabled-header-a"
                ...
                <li>
                  <a className="s-disabled" href="/cgi-bin/submitData.pl">
                    Submit Data
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a className="disabled-header-a" href="#">
                    API
                  </a>
                </li>
              </ul>
            </li>
            <li className="has-dropdown" id="info-menu">
              <a href="#">Info &amp; Downloads</a>
              <ul className="dropdown">
                <li>
                  <a
                    className="disabled-header-a"
                ...
                <li>
                  <a className="disabled-header-a" href="/blog">
                    Blog
                  </a>
                </li>
                <li>
                  <a
                    className="disabled-header-a"
                    href="https://downloads.yeastgenome.org"
                  >
                    Downloads
                  </a>
                </li>
                <li>
                  <a className="disabled-header-a" href="/site-map">
                    Site Map
                  </a>
                </li>
                <li>
