...
$(document).ready(function() {
  	...
  	set_up_reference_list("references", "references_list", "references_list_empty_message", "references_list_wrapper", "references_list_download", experiment['display_name'] + "_citations", experiment['references']);
