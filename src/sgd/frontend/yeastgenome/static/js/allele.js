$(document).ready(function() {
	...
	$.getJSON('/redirect_backend?param=allele/SGD:' + allele['sgdid']  + '/phenotype_details', function(data) {
	    var phenotype_table = create_phenotype_table(data);
  	    create_download_button("phenotype_table_download", phenotype_table, allele['display_name'] + "_phenotype_annotations");
	});

        $.getJSON('/redirect_backend?param=allele/SGD:' + allele['sgdid']  + '/interaction_details', function(data) {
        ...
        $.getJSON('/redirect_backend?param=allele/SGD:' + allele['sgdid']  + '/network_graph', function(data) {
