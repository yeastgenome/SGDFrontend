...
$(document).ready(function () {
    ...
    $.getJSON('/redirect_backend?param=locus/' + locus['id'] + '/sequence_details', function (data) {
    ...
    $.getJSON('/redirect_backend?param=locus/' + locus['id'] + '/neighbor_sequence_details', function (data) {
