...
Feature: SEARCH
    ...
    Scenario: go to LSP for an ORF name
    	...
    	And I wait 2 seconds
    	And I should be at "/locus/S000003826/overview"
    ...
    Scenario: go to LSP for a primary SGDID
        ...
        And I wait 2 seconds
        And I should be at "/locus/S000006778/overview"
   ...
   Scenario: go to LSP for a secondary SGDID
	...
	And I wait 2 seconds
        And I search "BUD2"
        And I wait 2 seconds
        And I should be at "/locus/S000001575/overview"
	...
	And I wait 2 seconds
        And I search "SME1"
        And I wait 2 seconds
        And I should be at "/cgi-bin/search/luceneQS.fpl?query=SME1"
    ...
    Scenario: go to LSP for gene name with punctuation
        ...
        And I search "DUR1,2"
        And I wait 2 seconds
        And I should be at "/locus/S000000412/overview"
    ...
    Scenario: go to LSP for gene name with punctuation
        ...
        And I wait 2 seconds
        And I should be at "/locus/S000007645/overview" 
    ...
    Scenario: go to LSP for a tRNA name 
        ...
        And I wait 2 seconds
        And I should be at "/locus/S000006779/overview"
	...
	And I search "kinase"
	And I wait 2 seconds
	And I should be at "/cgi-bin/search/luceneQS.fpl?query=kinase"
     ...
     Scenario: go to "old" lucene search for wildcard search (eg, act*)
        ...
        And I search "act*"
        And I wait 2 seconds
        And I should be at "/cgi-bin/search/luceneQS.fpl?query=act%2A"
     ...
     Scenario: go to "old" lucene search for "eurie" wildcard search (eg, 1,*)
        ...
        And I search "1,*"
        And I wait 2 seconds
        And I should be at "/cgi-bin/search/luceneQS.fpl?query=1%2C%2A"
      ...
      Scenario: go to LSP for a short gene name (eg, HO)
        ...
        And I search "HO"
        And I wait 2 seconds
        And I should be at "/locus/S000002386/overview"
      ...
      Scenario: go to reference page for a pmid
        ...
        And I wait 2 seconds
        And I should be at "/reference/S000044948/overview"
      ...
      Scenario: go to GO term page for a GOID
        ...
        And I search "7533"
        And I wait 2 seconds
        And I should be at "/go/GO:0007533/overview"
