...
from sgdfrontend.link_maker import go_overview_table_link, go_f_filename, \
    ...
    interaction_graph_link, bioent_overview_table_link, bioent_evidence_table_link, \
    go_evidence_table_link, phenotype_evidence_table_link, bioent_evidence_link, \
    locus_link, bioent_link
