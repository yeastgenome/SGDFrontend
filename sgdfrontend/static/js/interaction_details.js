...
$(document).ready(function() {
    ...
    $.getJSON(interaction_details_link, function(data) {
        ...
        create_download_button("evidence_table_download", interaction_table, download_table_link, evidence_table_filename);
        create_analyze_button("evidence_table_analyze", interaction_table, analyze_link, analyze_filename + ' interactors', true);
...
function create_interaction_table(data) {
    ...
    if(data != null && data.length > 0) {
        ...
        $("#evidence_gene_header").html(Object.keys(genes).length);
