...
function set_up_evidence_table(header_id, phenotype_header_id, table_id, download_button_id, download_link, download_table_filename, 
	analyze_button_id, analyze_link, analyze_list_name, data) {
	...
	options["aaData"] = datatable;
  	...
  	document.getElementById(analyze_button_id).onclick = function() {analyze_table(analyze_link, analyze_list_name, ev_table, 1, format_name_to_id)};
