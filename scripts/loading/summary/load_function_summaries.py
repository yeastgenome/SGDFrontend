...
if __name__ == "__main__":
    ...
    if len(sys.argv) >= 3:
        ...
        print("Example: load_function_summaries.py 16-11phenoSummaries.txt Phenotype")
        print("Example: load_function_summaries.py 16-5regulationSummaries.txt Regulation")
        print("Example: load_function_summaries.py gp_information.559292_sgd Function")
        exit()
