...
if __name__ == '__main__':
    ...
    if len(sys.argv) >= 2:
        ...
        print "Usage example: python load_phenotype.py data/phenotype_dataCuration091717.tsv"
        exit()
    
    logfile = "scripts/loading/phenotype/logs/" + infile.split('/')[1].replace(".txt", ".log")
