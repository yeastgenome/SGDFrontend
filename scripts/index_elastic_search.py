...
def index_strains():
    ...
    for strain in strains:
        ...
        obj = {
            ...
            "href": strain.obj_url,
            "description": None, #strainsummary?
            "category": "strain",
            "keys": list(keys)
        }
...
def index_references():
    ...
    for reference in references:
        ...
        sec_sgdid = DBSession.query(ReferenceAlias.display_name).filter_by(reference_id=reference.dbentity_id).one_or_none()
        if sec_sgdid:
