...
class StraindbentityTest(unittest.TestCase):
    ...
    def test_should_return_valid_strain_name(self, mock_search, mock_redis):
        ...
        id = mock_redis.extract_id_request(request, 'strain', param_name='id')
    ...
    @mock.patch('src.models.DBSession.query')
    def test_should_return_non_existent_strain(self, mock_search, mock_redis):
