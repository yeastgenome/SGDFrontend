...
class ObservableTest(unittest.TestCase):
    ...
    @mock.patch('src.models.DBSession.query')
    def test_should_return_non_existent_observable(self, mock_search):
    ...
    @mock.patch('src.models.DBSession.query')
    def test_should_return_non_existent_observable_locus_details(self, mock_search):
        mock_search.return_value = MockQuery(None)
    ...
    @mock.patch('src.models.DBSession.query')
    def test_should_return_non_existent_observable_locus_details_all(self, mock_search):
        mock_search.return_value = MockQuery(None)
    ...
    @mock.patch('src.models.DBSession.query')
    def test_should_return_non_existent_observable_ontology_graph(self, mock_search):
        mock_search.return_value = MockQuery(None)
