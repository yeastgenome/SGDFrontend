...
class SGDViewTests(unittest.TestCase):
    ...
    def test_sequence_page(self):
        from src.sgd.frontend.views import sequence_details
        req = testing.DummyRequest()
        req.matchdict = { 'identifier': EXAMPLE_IDENTIFIER }
    ...
    def test_protein_page(self):
        from src.sgd.frontend.views import protein_details
        req = testing.DummyRequest()
        req.matchdict = { 'identifier': EXAMPLE_IDENTIFIER }
    ...
    def test_go_page(self):
        from src.sgd.frontend.views import go_details
        req = testing.DummyRequest()
        req.matchdict = { 'identifier': EXAMPLE_IDENTIFIER }
        res = go_details(req)
        self.assertEqual(res.status_code, 200)
    ...
    def test_phenotype_page(self):
        from src.sgd.frontend.views import phenotype_details
        req = testing.DummyRequest()
        req.matchdict = { 'identifier': EXAMPLE_IDENTIFIER }
    ...
    def test_interactions_page(self):
        from src.sgd.frontend.views import interaction_details
        req = testing.DummyRequest()
        req.matchdict = { 'identifier': EXAMPLE_IDENTIFIER }
    ...
    def test_regulation_page(self):
        from src.sgd.frontend.views import regulation_details
        req = testing.DummyRequest()
        req.matchdict = { 'identifier': EXAMPLE_IDENTIFIER }
    ...
    def test_expression_page(self):
        from src.sgd.frontend.views import expression_details
        req = testing.DummyRequest()
        req.matchdict = { 'identifier': EXAMPLE_IDENTIFIER }
    ...
    def test_literature_page(self):
        from src.sgd.frontend.views import literature_details
        req = testing.DummyRequest()
        req.matchdict = { 'identifier': EXAMPLE_IDENTIFIER }
    ...
    def test_curator_sequence(self):
        from src.sgd.frontend.views import curator_sequence
        req = testing.DummyRequest()
        req.matchdict = { 'identifier': EXAMPLE_IDENTIFIER }
